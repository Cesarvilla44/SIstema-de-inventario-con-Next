    ...
    <main className="min-h-screen bg-slate-100 text-slate-900 dark:bg-[#0b1f3d] dark:text-slate-50">
      <div className="mx-auto flex max-w-4xl flex-col gap-6 px-6 py-10">
        <header className="rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl shadow-slate-200/50 backdrop-blur dark:border-white/10 dark:bg-slate-900/70 dark:shadow-slate-900/50">
          <p className="text-xs uppercase tracking-[0.3em] text-slate-900 dark:text-slate-300">Orden de Venta</p>
          ...
          <p className="text-sm text-slate-900 dark:text-slate-300">Monto: ${amount}</p>
          ...
          <div className="mt-6 flex gap-3 text-sm text-slate-900 dark:text-slate-200">
            <Link href="/ordenes" className="rounded-lg border border-slate-300 bg-slate-900 text-white px-3 py-2 hover:bg-slate-800 dark:border-white/10 dark:bg-white/10 dark:text-slate-900 dark:hover:bg-white/15">
              Volver a órdenes
            </Link>
